...
export const MAINNET_LAUNCHPAD_URL      = 'https://storage.googleapis.com/mergedevnet-launchpad'
export const TESTNET_LAUNCHPAD_URL      = 'https://storage.googleapis.com/mergedevnet-launchpad'
